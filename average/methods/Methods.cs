...
namespace Methods
{
  class MethodsArray
  {
    // Método principal da classe 'MethodsArray'. Este método sempre será executa após instanciar está classe.
    static void Main()
    {
      int[] vetor = new int[3];
      ...
      string[,] matriz = new string[1, 2] { { "Renan", "Ruth" } };
      ...
      Divide(dividend, divider, out int rest);
    ...
    // Este métodos podem ou não retornar um tipo/valor e pordem ou não receber parâmetros.
